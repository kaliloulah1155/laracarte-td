...
@section('content')
    <div class="container">
    	...
    	<p>Feel free to help to improve the <a href="https://github.com/kaliloulah1155/laracarte-td">source code</a> .</p>
    	<hr>
    	...
    	<p>Basically it's built on {{config('app.name')}} & Bootstrap. But there's a bunch of services used for email and other sections.</p>
    	<ul>
    	    <li>Laravel</li>
    	    <li>Bootstrap</li>
    	    <li>Amazon S3</li>
